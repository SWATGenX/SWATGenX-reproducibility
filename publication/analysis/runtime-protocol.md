...
1. Use a **single** locked row from `publication/tables/tab-model-complexity.csv` (`status=locked_from_inventory`, `level=huc12`). Default pilot `--model-id` is Small `0308/huc12/02239501`; pass another locked `model_id` (e.g. Medium `0204/huc12/01451800`, Large `1107/huc12/07174000`) for tier-specific timing.
